...
class BookListView(generic.ListView):
    ...
    '''def get_queryset(self):
        return models.Book.objects.filter(title__icontains='war')[:5] # Get 5 books containing the title war'''
...
class AuthorCreate(PermissionRequiredMixin, CreateView):
    ...
    initial = {'date_of_death': 'MM/DD/YYYY', 'date_of_birth': 'MM/DD/YYYY'}
